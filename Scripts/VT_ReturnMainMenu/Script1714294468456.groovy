...
WebUI.click(findTestObject('Object Repository/VT_ReturnMainMenu/Page_JPetStore Demo/a_Enter the Store'))

WebUI.click(findTestObject('Object Repository/VT_ReturnMainMenu/Page_JPetStore Demo/img'))
